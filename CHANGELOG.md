...
- Fixed the typing indicator covering and clipping the last message, and the responding indicator resizing thread replies, by reserving one steady status band above both composers.
